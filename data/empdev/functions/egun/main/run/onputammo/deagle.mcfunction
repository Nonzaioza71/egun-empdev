# execute as @s at @s if entity @s[nbt={Inventory:[{id:"minecraft:iron_nugget", tag:{CustomModelData:1000}}]}] if score @s player.state.magazine.ammo matches 0.. run item modify entity @s weapon.mainhand empdev:deagle_mag/deagle_mag_put_more15
execute as @s at @s if entity @s[nbt={Inventory:[{id:"minecraft:iron_nugget", tag:{CustomModelData:1000}}]}] if score @s player.state.magazine.ammo matches 0.. run item modify entity @s weapon.mainhand empdev:deagle_mag/deagle_mag_put
# execute as @s at @s if entity @s[nbt={Inventory:[{id:"minecraft:iron_nugget", tag:{CustomModelData:1000}}]}] if score @s player.state.magazine.ammo matches 7..9 run item modify entity @s weapon.mainhand empdev:deagle_mag/deagle_mag_put_full
