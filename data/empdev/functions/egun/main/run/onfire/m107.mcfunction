...
execute as @s at @s if score @s player.state.rc.random matches 1 run tp @s ~ ~ ~ facing ^1 ^1 ^10
execute as @s at @s if score @s player.state.rc.random matches 2 run tp @s ~ ~ ~ facing ^-1 ^1 ^10
execute as @s at @s if score @s player.state.rc.random matches 3 run tp @s ~ ~ ~ facing ^1 ^2 ^10
execute as @s at @s if score @s player.state.rc.random matches 4 run tp @s ~ ~ ~ facing ^-1 ^2 ^10
execute as @s at @s if score @s player.state.rc.random matches 5 run tp @s ~ ~ ~ facing ^2 ^1 ^10
execute as @s at @s if score @s player.state.rc.random matches 6 run tp @s ~ ~ ~ facing ^-2 ^1 ^10
execute as @s at @s if score @s player.state.rc.random matches 7 run tp @s ~ ~ ~ facing ^2 ^2 ^10
execute as @s at @s if score @s player.state.rc.random matches 8 run tp @s ~ ~ ~ facing ^-2 ^2 ^10
execute as @s at @s if score @s player.state.rc.random matches 9 run tp @s ~ ~ ~ facing ^3 ^1 ^10
execute as @s at @s if score @s player.state.rc.random matches 10 run tp @s ~ ~ ~ facing ^-3 ^1 ^10
